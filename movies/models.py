...
class Movie(core_models.TimeStampedModel):
    ...
    naver = models.CharField(max_length=50, blank=True)
    naver_link = models.CharField(max_length=50, blank=True)
    rotten = models.CharField(max_length=50, blank=True)
    rotten_link = models.CharField(max_length=50, blank=True)
    imdb = models.CharField(max_length=50, blank=True)
    imdb_link = models.CharField(max_length=50, blank=True)
